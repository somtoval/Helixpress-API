"""
Django settings for helixpress_api project.
...
SECRET_KEY = "django-insecure-=_)#n)!3fvh$qxi5!tu%m2-^_!c%mzjdt_9qymbbr$w6^kxjuo"
...
ROOT_URLCONF = "helixpress_api.urls"
...
WSGI_APPLICATION = "helixpress_api.wsgi.application"
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # To use the django admin login simuteanously with the browseable api view of djoser you need to add this 
